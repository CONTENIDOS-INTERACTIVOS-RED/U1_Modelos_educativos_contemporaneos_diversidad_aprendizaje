        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad "Modelos educativos contemporáneos y diversidad en el aprendizaje" presenta una visión crítica y contextualizada de los modelos pedagógicos actuales. Explora su evolución histórica, fundamentos teóricos, enfoques centrados en el estudiante y su adaptación a distintos contextos. Destaca el papel activo del alumno, el valor de la diversidad sociocultural, y la necesidad de una pedagogía flexible. Incluye referentes clásicos como Piaget, Vygotsky, Freire y Rousseau. Finaliza con una propuesta de estudio de caso y herramientas para evaluar la aplicabilidad de estos modelos en entornos educativos diversos.
